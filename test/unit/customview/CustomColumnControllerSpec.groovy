 ...
 */
@TestFor(CustomColumnController)
@Mock([View,Column])
class CustomColumnControllerSpec extends Specification {
	...
	void "index redirects to list"() {
		...
		then:
		"/customColumn/list" == response.redirectedUrl
	}
	...
	void "save redirects to show"() {
		...
		then:
		"/customColumn/show/2" == response.redirectedUrl
	}
	...
	void "update redirects to show"() {
		...
		then:
		"/customColumn/show/1" == response.redirectedUrl
	}
